...
function drawText() {
    ...
    if(frameNumber > 2500 && frameNumber < 99999){
        ...
        if (window.innerWidth < 600) {
            drawTextWithLineBreaks(["Jainudaaaaa I miss you so so sooo much more", "Knowing that you are thousand miles apart makes me miss you more each and every hour | minute | Second "], canvas.width / 2, canvas.height / 2, fontSize, lineHeight);
        } else {
            context.fillText("Jainudaaaaa I miss you so so sooo much more Knowing that you are thousand miles apart makes me miss you more each and every hour | minute | Second", canvas.width/2, canvas.height/2);
        }
